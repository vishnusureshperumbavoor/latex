...
\end{figure}
    ...
    \end{center}
    \vspace{.5cm}
    \textform{This is to certify that the project report entitled \textbf{JobConnect - A Job Searching Application} submitted by \textbf{Reshma Babu} is approved for submission requirement for 6009 -Project and Seminar in  $6^{th}$ semester Computer Engineering at Govt.Polytechnic College,Perumbavoor.}\\[0.15cm]
