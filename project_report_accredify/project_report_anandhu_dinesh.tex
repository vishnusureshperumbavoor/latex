...
\fontsize{14}{25}\selectfont{\textbf{PROJECT REPORT}}\\[.1cm]
    ...
    \fontsize{14}{25}\selectfont \bfseries{ANANDHU DINESH}\\[.1cm]
    \fontsize{12}{25}\selectfont{\textbf{20130086}}\\[.2cm]
%\vfill
 \end{center}
...
\end{figure}
    ...
    \end{center}
    \vspace{.5cm}
    \textform{This is to certify that the project report entitled \textbf{Accredify - The Accrditation Management System} submitted by \textbf{Anandhu Dinesh} is approved for submission requirement for 6009 -Project and Seminar in  $6^{th}$ semester Computer Engineering at Govt.Polytechnic College,Perumbavoor.}\\[0.15cm]
