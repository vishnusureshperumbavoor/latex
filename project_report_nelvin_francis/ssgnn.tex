...
\fontsize{14}{25}\selectfont{\textbf{PROJECT REPORT}}\\[.1cm]
    ...
    \fontsize{14}{25}\selectfont \bfseries{NELVIN FRANCIS D SILVA}\\[.1cm]
    \fontsize{12}{25}\selectfont{\textbf{20130119}}\\[.2cm]
%\vfill
 \end{center}
...
\end{figure}
    ...
    \end{center}
    \vspace{.5cm}
    \textform{This is to certify that the project report entitled \textbf{Accredify} submitted by \textbf{Nelvin Francis D Silva}.The project report is approved for submission requirement for 6009 -Project and Seminar in  $6^{th}$ semester Computer Engineering at Govt.Polytechnic College,Perumbavoor.}\\[0.15cm]
